...
public class ProvaSVNPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProvaSVN";
	...
	private ProvaSVNPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProvaSVNPersistentManager();
		}

 ...
 * @author Antonio
 */
public class CassiereHomeView extends javax.swing.JPanel {
   ...
   public CassiereHomeView(Main PanP) {
        initComponents();
	PagePanel = PanP;
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Inserisci PIN");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/home_company.png"))); // NOI18N
        ...
        jButton1.setText("Nuovo Cliente");
        ...
        jButton2.setText("Modifica Cliente");
        ...
        jButton4.setText("Disattiva Tessera");
        ...
        jButton5.setText("Cambia Tessera");
        ...
        jButton5.setBounds(330, 270, 190, 30);
        jLayeredPane2.add(jButton5, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jButton6.setText("Ricarica Tessera");
        ...
        jButton6.setBounds(330, 230, 190, 30);
    ...
    private void jLayeredPane2AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLayeredPane2AncestorAdded
        try {
            ...
            Logger.getLogger(CassiereHomeView.class.getName()).log(Level.SEVERE, null, ex);
       ...
       try {
                if (cl.getCassiere(ControllerFactoryClient.getInstance().getTerminale()) != null) {
                    ...
                    jLabel8.setText("<identifica operatore>");
                    jLabel15.setText("Inserisci PIN");
                    jButton3.setText("Login");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PagePanel.activeView("NuovoClienteView");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      ...
      // cl.setLogin("login");
       if(jButton3.getText().equals("Login")){
        ...
        try {
                try {
                    //ControllerFactoryClient.getInstance().setTerminale(cl.CaricaTerminale());
                    cl.LoginCassiere(jTextField2.getText(), ControllerFactoryClient.getInstance().getTerminale());
                } catch (Exception ex) {
                    Logger.getLogger(CassiereHomeView.class.getName()).log(Level.SEVERE, null, ex);
                }
            cassiere=cl.getCassiere(ControllerFactoryClient.getInstance().getTerminale());
           // n_noleggi=ControllerLogin.getN_noleggi();
            if (cassiere != null)
                {
                    jTextField2.setVisible(false);
                    jButton3.setText("Logout");
            ...
            else
                {
                    ...
                    jLabel17.setText("ATTENZIONE!!! PIN non valido!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        PagePanel.activeView("ModificaClienteView");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
         PagePanel.activeView("CambiaTesseraView");
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        PagePanel.activeView("EliminaClienteView");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        PagePanel.activeView("RicaricaTesseraView");

 ...
 * @author Antonio
 */
public class RiepilogoModificaClienteView extends javax.swing.JPanel {
   ...
   public RiepilogoModificaClienteView(Main PanP) {
        initComponents();
	PagePanel = PanP;
    ...
    private void jLayeredPane2AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLayeredPane2AncestorAdded
        try {
            ...
            Logger.getLogger(RiepilogoModificaClienteView.class.getName()).log(Level.SEVERE, null, ex);
        }

 ...
 * @author Antonio
 */
public class RiepilogoEliminaClienteView extends javax.swing.JPanel {
   ...
   public RiepilogoEliminaClienteView(Main PanP) {
        initComponents();
	PagePanel = PanP;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("La tessera è stata disattivata correttamente");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(RiepilogoEliminaClienteView.class.getName()).log(Level.SEVERE, null, ex);

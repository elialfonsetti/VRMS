 ...
 * @author Antonio
 */
public class ModificaClienteView extends javax.swing.JPanel {
   ...
   public ModificaClienteView(Main PanP) {
        initComponents();
	PagePanel = PanP;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            Logger.getLogger(ModificaClienteView.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            try {
                cc.ModificaCliente(cliente);
                cc.setCliente(cliente,ControllerFactoryClient.getInstance().getTerminale());
            } catch (Exception ex) {
                Logger.getLogger(ModificaClienteView.class.getName()).log(Level.SEVERE, null, ex);
            }
            PagePanel.activeView("RiepilogoModificaClienteView");
        } catch (RemoteException ex) {
            Logger.getLogger(ModificaClienteView.class.getName()).log(Level.SEVERE, null, ex);
        }

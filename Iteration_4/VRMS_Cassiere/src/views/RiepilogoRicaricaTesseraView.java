 ...
 * @author Antonio
 */
public class RiepilogoRicaricaTesseraView extends javax.swing.JPanel {
   ...
   public RiepilogoRicaricaTesseraView(Main PanP) {
        initComponents();
	PagePanel = PanP;
    ...
    private void initComponents() {
        ...
        jLabel3.setText("La ricarica è stata effettuata correttamente");
        jLabel3.setBounds(14, 57, 840, 20);
        jLayeredPane2.add(jLabel3, javax.swing.JLayeredPane.DEFAULT_LAYER);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setBounds(4, 90, 850, 30);
    ...
    private void jLayeredPane1AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLayeredPane1AncestorAdded
        try {
            ...
            jLabel2.setText("Il nuovo credito della tessera è di " + cc.getCliente(ControllerFactoryClient.getInstance().getTerminale()).getTessera_personale().getCredito() + " euro");
        } catch (Exception ex) {
            Logger.getLogger(RiepilogoRicaricaTesseraView.class.getName()).log(Level.SEVERE, null, ex);
        }

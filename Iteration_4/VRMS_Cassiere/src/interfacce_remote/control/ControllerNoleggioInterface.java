...
public interface ControllerNoleggioInterface extends Remote{
   ...
   public ArrayList<FormatoInterface> OttieniFormati()  throws  Exception,RemoteException;
   ...
   public float OttieniCostoFormato(String combo) throws  Exception,RemoteException;
    ...
    public float CalcolaAggiuntaRestituzione(FilmInterface copia ,int giorni) throws  Exception,RemoteException;

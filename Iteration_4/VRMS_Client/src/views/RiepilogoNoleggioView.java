 ...
 * @author Antonio
 */
public class RiepilogoNoleggioView extends javax.swing.JPanel {
   ...
   public RiepilogoNoleggioView(Main PanP) {
        initComponents();
	PagePanel = PanP;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Noleggio Completato");
        ...
        jLabel1.setBounds(470, 220, 350, 40);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
            ...
            try {
                ...
                Logger.getLogger(RiepilogoNoleggioView.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jLayeredPane2AncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jLayeredPane2AncestorAdded
        ...
        try {
            ...
            TransizioneInterface noleggio = cn.getNoleggio(ControllerFactoryClient.getInstance().getTerminale());
